  ...
  export default function page() {
    ...
    if (companies.data === undefined || companies.data.length === 0) {
        ...
        <BlankSlate 
            ...
            actions={
                <Create destination={`/settings/companies/create`} name={"Company"}/>
            }
        />
        )
    }
    ...
    {/*                             formatDateToLocal(record.project._creationTime.toString()) */}
                                <TableCell className="text-right">
                                    <TableOptions>
                                        <Edit destination={`/settings/companies/${encodeURIComponent(record.company._id)}/edit`}/>
