  ...
  export default function page() {
    ...
    if (data === undefined || data.length === 0) {
        ...
        <BlankSlate 
            ...
            actions={
                <Create destination={"dashboard/settings/occupations/create"} name={"Occupation"}/>
            }
        />
        )
    }
    ...
    {/*                             formatDateToLocal(record.project._creationTime.toString()) */}
                                <TableCell className="text-right">
                                    <TableOptions>
                                            <Edit destination={`/dashboard/settings/occupations/${encodeURIComponent(record.occupation._id)}/edit`}/>
...
const Delete = ({id}: {id: Id<"Occupation">}) => {
    ...
    return (
        <DropdownMenuItem onClick={() => deleteOccupation({id})}>
